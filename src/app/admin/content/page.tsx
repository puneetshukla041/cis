  ...
  return (
    <div className="space-y-6 animate-in">
      <section className="hero-card p-6 md:p-8">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-7 text-muted">Only approved Learning Library questions are allowed in practice generation. This page checks duplicates, banned phrases, weak explanations, missing tags and missing metadata.</p>
      </section>
      ...
      <section className="grid gap-4 lg:grid-cols-[1fr_360px]">
        <div className="card overflow-hidden">
          <div className="border-b p-5" style={{ borderColor: "var(--border)" }}>
            ...
            <p className="mt-1 text-sm text-muted">Status uses approved ratio minus quality issues. Any topic below 80 should be reviewed before final release.</p>
          </div>
